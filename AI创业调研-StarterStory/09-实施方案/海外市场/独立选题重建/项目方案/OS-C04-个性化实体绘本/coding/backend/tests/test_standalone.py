...
CODE = 'C04'
CREATE, ACTION, BODY = ({'title': 'Adventure', 'childName': 'Mia', 'companion': 'fox', 'setting': 'garden', 'dedication': 'For Mia'}, 'personalize', {'title': 'New adventure', 'childName': 'Mia', 'companion': 'fox', 'setting': 'garden', 'dedication': 'For Mia', 'replacePages': True})
